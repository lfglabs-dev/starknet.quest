...
>(({ ...props }, ref) => (
  <thead
    ref={ref}
    className="[&_tr]:border-[1px] [&_tr]:border-[#f4faff4d] [&_tr]:border-t-0 [&_tr]:border-l-0 [&_tr]:border-r-0 [&_tr]:py-3 [&_tr]:px-4"
    {...props}
  />
));
...
>(({ ...props }, ref) => (
  <tfoot
    ref={ref}
    className="border-[1px] border-[#f4faff4d] bg-muted/50 font-medium [&>tr]:last:border-b-0 [&_tr]:py-3 [&_tr]:px-4"
    {...props}
  />
));
