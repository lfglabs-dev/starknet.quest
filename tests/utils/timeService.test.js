import { timeElapsed, timeFrameMap } from "@utils/timeService";
...
describe("timeFrameMap function", () => {
  it("should return 'week' for 'Last 7 Days'", () => {
    expect(timeFrameMap("Last 7 Days")).toBe("week");
  });

  it("should return 'month' for 'Last 30 Days'", () => {
    expect(timeFrameMap("Last 30 Days")).toBe("month");
  });

  it("should return 'all' for 'All time'", () => {
    expect(timeFrameMap("All time")).toBe("all");
  });

  it("should return 'week' for unknown input", () => {
    expect(timeFrameMap("Unknown")).toBe("week");
  });
});
